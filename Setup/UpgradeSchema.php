...
namespace Creativestyle\ProductPositiveIndicatorsExtension\Setup;
...
class UpgradeSchema implements \Magento\Framework\Setup\UpgradeSchemaInterface
{
    ...
    public function upgrade(\Magento\Framework\Setup\SchemaSetupInterface $setup, \Magento\Framework\Setup\ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '0.0.8', '<')) {
            $this->upgradeToVersion008($setup);
        }
    }
    ...
    public function upgradeToVersion006(\Magento\Framework\Setup\SchemaSetupInterface $setup)
    {
        ...
        $connection->addColumn(
            $table,
            'top_attribute_calculated_value',
            [
                'type' => \Magento\Framework\DB\Ddl\Table::TYPE_TEXT,
    ...
    public function upgradeToVersion008(\Magento\Framework\Setup\SchemaSetupInterface $setup)
    {
        $setup->startSetup();
        $connection = $setup->getConnection();

        // drop top_attribute_value
        $catalogAttributeTable = $setup->getTable('catalog_eav_attribute');
        $connection->changeColumn(
            $catalogAttributeTable,
            'top_attribute_calculated_value',
