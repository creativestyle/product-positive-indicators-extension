...
namespace Creativestyle\ProductPositiveIndicatorsExtension\Plugin;
...
{
    /**
     * @var \Creativestyle\ProductPositiveIndicatorsExtension\Parser\TopAttributeInterface
     */
    private $parser;
    ...
    public function __construct(\Creativestyle\ProductPositiveIndicatorsExtension\Parser\TopAttributeInterface $parser, \Magento\Swatches\Helper\Data $swatchHelper, \Magento\Framework\Serialize\Serializer\Json $serializer)
    {
        $this->parser = $parser;
