...
namespace Creativestyle\ProductPositiveIndicatorsExtension\Block\OnlyXAvailable;

class Product extends \Magento\Framework\View\Element\Template
{
    protected $_template = 'Creativestyle_ProductPositiveIndicatorsExtension::onlyxavailable/product.phtml';
    ...
    public function __construct(
        ...
        \Creativestyle\FrontendExtension\Service\Breadcrumb\BreadcrumbCategoryFinderInterface $categoryFinder,
        array $data = []
    ) {
