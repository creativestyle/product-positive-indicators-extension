...
namespace Creativestyle\ProductPositiveIndicatorsExtension\Console\Command;

class TopAttributeRefresh extends \Symfony\Component\Console\Command\Command
{
    /**
     * @var \Creativestyle\ProductPositiveIndicatorsExtension\Cron\TopAttributeRefreshFactory
     */
    private $cronTopAttributeRefreshFactory;

    public function __construct(\Creativestyle\ProductPositiveIndicatorsExtension\Cron\TopAttributeRefreshFactory $cronTopAttributeRefreshFactory)
    {
    ...
    protected function execute(\Symfony\Component\Console\Input\InputInterface $input, \Symfony\Component\Console\Output\OutputInterface $output)
    {
        ...
        try {
            /** @var \Creativestyle\ProductPositiveIndicatorsExtension\Cron\TopAttributeRefresh $cronTopAttributeRefresh */
