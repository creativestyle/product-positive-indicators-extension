...
namespace Creativestyle\ProductPositiveIndicatorsExtension\Test\Unit\Service;

class OrderQueueLengthUpdaterTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var \Creativestyle\ProductPositiveIndicatorsExtension\Service\OrderQueueLengthUpdater
     */
    ...
    protected function setUp()
    {
        ...
        $this->orderQueueLengthUpdater = $objectManager->getObject(\Creativestyle\ProductPositiveIndicatorsExtension\Service\OrderQueueLengthUpdater::class);
    }
