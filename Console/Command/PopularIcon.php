...
class PopularIcon extends \Symfony\Component\Console\Command\Command
{
    ...
    /**
     * @var \Creativestyle\ProductPositiveIndicatorsExtension\Model\PopularIconProductsFactory
     */
    ...
    public function __construct(
        ...
        \Creativestyle\ProductPositiveIndicatorsExtension\Model\PopularIconProductsFactory $popularIconProductsFactory
    )
    {
        parent::__construct();
