...
{
    /**
     * @var \Creativestyle\ProductPositiveIndicatorsExtension\Service\DeliveryDataProvider
     */
    ...
    protected function setUp()
    {
        ...
        $this->deliveryDataProvider = $objectManager->getObject(\Creativestyle\ProductPositiveIndicatorsExtension\Service\DeliveryDataProvider::class);
    }
