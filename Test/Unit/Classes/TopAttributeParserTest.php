...
namespace Creativestyle\ProductPositiveIndicatorsExtension\Test\Unit\Classes;

class TopAttributeParserTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var \Creativestyle\ProductPositiveIndicatorsExtension\Parser\TopAttribute
     */
    private $topAttributeParser;

    protected function setUp()
    {
        $this->topAttributeParser = new \Creativestyle\ProductPositiveIndicatorsExtension\Parser\TopAttribute();
    }
