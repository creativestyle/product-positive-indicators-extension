...
namespace Creativestyle\ProductPositiveIndicatorsExtension\Test\Integration\Service;
...
class FreeShippingTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Creativestyle\ProductPositiveIndicatorsExtension\Service\FreeShipping
     */
    ...
    public function setUp()
    {
        ...
        $this->freeShippingService = $this->objectManager
            ->get(\Creativestyle\ProductPositiveIndicatorsExtension\Service\FreeShipping::class);
